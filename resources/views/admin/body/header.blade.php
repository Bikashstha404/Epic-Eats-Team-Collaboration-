        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <span class="logo logo-dark">
                    <span class="logo-sm">
                        <i class="bi bi-person-gear" style="font-size: 28px; margin-right: 4px;"></i>
                    </span>
                    <span class="logo-lg">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-person-gear" style="font-size: 28px; margin-right: 4px;"></i> <span class="logo-txt mt-2">Admin</span>
                        </div>
                    </span>
                </span>
                ...
                <span class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <div class="d-flex align-items-center">
                            <i class="bi bi-person-gear" style="font-size: 28px; margin-right: 4px;"></i>
                            <span class="logo-txt mt-2">Admin</span>
                        </div>
                    </span>
                </span>
            </div>
