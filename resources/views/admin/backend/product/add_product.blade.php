                    ...
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" action="{{ route('admin.product.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="" class="p-1 bg-primary" width="210" height="120">
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                ...
                discount_price: {
                    number: 'Please enter a valid number for Discount Price',
                    min: 'Discount Price must be at least 0',
                },
            },
            errorElement: 'span',
