                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3 mt-lg-0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" name="gallery_img" type="file" id="image" accept="image/*">
                                        </div>
                                        <div class="mb-3">

                                            <img id="showImage" src="{{ asset($gallery->gallery_img) }}" alt="" class=" p-1 bg-primary" width="210" height="120">
                                        </div>
                                        <div class="mt-4">
