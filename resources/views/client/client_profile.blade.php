                                ...
                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3">
                                            <img src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle d-block bg-primary" style="width: 90px; height: 90px; object-fit: cover;">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="cover_photo" type="file" id="coverImage">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img id="showProfileImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" style="width: 90px; height: 90px; object-fit: cover;">
                                    </div>
                                    <div class="mt-4">
