                                ...
                                <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                    <div class="list-card-image">
                                        <a href="{{ route('res.details',$wish->client_id) }}">
                                            <img src="{{ !empty($wish['client']['photo']) ? asset('upload/client_images/' . $wish['client']['photo']) : asset('upload/no_image.jpg') }}" class="img-fluid item-img" style="width: 300px; height:200px;" alt="Client Image">
                                        </a>
                                    </div>
